...
class PagesTableSeeder extends Seeder
{
    public function run(): void
    {
        ...
        create(Page::class, [
            ...
            'content_en' => '<h1 class="text-center">Help on NFSU Cup</h1>
<p>This section contains information about online playing NFS Underground.Some tips about environment and game interface.</p>
<p><a href="/help/gameplay" class="link-text-info">Gameplay</a></p>
<p><a href="/help/faq" class="link-text-info">Faq</a></p>',
            'content_ru' => '<h1 class="text-center">Помощь на NFSU Cup</h1><p>В этом разделе информация об игре онлайн и по сети. Также есть немного подсказок по интерфейсу игры и настройке окружения (ОС, файрвол, роутер и т.п.)</p>
<p><a href="/help/gameplay" class="link-text-info">Геймплей</a></p>
<p><a href="/help/faq" class="link-text-info">FAQ</a></p>',
            'seo' => [
